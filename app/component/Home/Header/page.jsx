...
const DEFAULT_CONFIG = {
  ...
  userMenu: [
    { icon: "profile", label: "الملف الشخصي", href: "#" },
    { icon: "lessons", label: "دروسي", href: "#" },
    { icon: "exercises", label: "تمارين محلولة", href: "#" },
            ...
            <AnimatePresence mode="wait">
              {!user ? (
                ...
                >
                  ...
                  >
                    <div
                      className="w-[34px] h-[34px] rounded-[9px] flex items-center justify-center text-sm font-extrabold text-white flex-shrink-0"
                      style={{
                        background: `linear-gradient(135deg, ${theme.primary}, ${theme.accent})`,
                      }}
                    >
